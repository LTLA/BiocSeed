...
This is also helpful in applications involving simulations, e.g., Monte Carlo sampling.
...
This is intentional and allows the PRNG to progress further through the random number stream,
avoiding any biases from being limited to the sequence around the $2^{32}-1$ seed locations.
